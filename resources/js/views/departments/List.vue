<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button v-permission="['manage category']" class="filter-item" type="primary" icon="el-icon-plus" @click="handleCreate">
        {{ $t('table.add') }}
      </el-button>
    </div>
    <el-table v-loading="loading" :data="list" border fit highlight-current-row>
      ...
      <el-table-column v-permission="['manage category']" align="center" label="Actions" width="350">
        <template slot-scope="scope">
          <el-button v-permission="['manage category']" type="primary" size="small" icon="el-icon-edit" @click="handleEdit(scope.row.id, scope.row.name)">
            Edit
          </el-button>
    ...
    <el-dialog v-permission="['manage category']" :title="formTitle" :visible.sync="departmentFormVisible">
      <div class="form-container">
        <el-form ref="departmentForm" :model="currentDepartment" label-position="left" label-width="150px" style="max-width: 500px">
        ...
        <div slot="footer" class="dialog-footer">
          <el-button @click="departmentFormVisible = false">
            Cancel
          </el-button>
  ...
  methods: {
    ...
    handleSubmit(){
      ...
      if (this.currentDepartment.id !== undefined) {
        departmentResource.update(this.currentDepartment.id,this.currentDepartment).then(response => {
          this.$message({
            type: 'success',
        ...
        departmentResource
          ...
          .then(response => {
            this.$message({
              message: 'New Department ' + this.currentDepartment.name + ' has been created successfully.',
              type: 'success',
              duration: 5 * 1000,
            });
            this.resetForm();
